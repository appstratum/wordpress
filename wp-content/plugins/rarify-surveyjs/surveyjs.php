<?php
/*
Plugin Name: SurveyJS for Rarify
Plugin URI: https://wordpress.org/plugins/surveyjs
Description: Easy to use, drag & drop Survey Builder customized for use with Rarify.
Version: 1.8.23u001
Author: Devsoft Baltic OÜ and Two Impulse Lda.
Author URI: http://devsoftbaltic.com/
Copyright: Devsoft Baltic OÜ and Ultragenyx Pharmaceutical
*/
?>
<?php
